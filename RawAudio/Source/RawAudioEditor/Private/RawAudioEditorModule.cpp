...
#define LOCTEXT_NAMESPACE "FRawAudioEditorModule"


/**
 * Implements the SoftKineticPluginEditorEditor module.
 */
class FRawAudioEditorModule
...
IMPLEMENT_MODULE(FRawAudioEditorModule, RawAudioEditor);
